...
![Databricks DBU stack](/AndreaBozzo/blog/images/Databricks-DBU-Stack.png "Databricks DBU classes — Jobs, SQL, Serverless, Mosaic AI — stacked on shared EC2 infrastructure")
...
![Three lakehouse stacks compared](/AndreaBozzo/blog/images/Lakehouse-Three-Stacks.png "Databricks, AWS-Native, and DIY Iceberg stacks over a shared S3-compatible object storage layer")
...
![Lakehouse decision funnel](/AndreaBozzo/blog/images/Lakehouse-Decision-Funnel.png "Three filters that usually settle the lakehouse choice: team shape, warehouse footprint, portability appetite")
